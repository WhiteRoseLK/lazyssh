...
func DefaultStatusText() string {
	return "[white]↑↓[-] Navigate  • [white]Enter[-] SSH  • [white]f[-] Forward  • [white]x[-] Stop Forward  • [white]c[-] Copy SSH  • [white]v[-] Paste SSH  • [white]y[-] Clone  • [white]h[-] Copy Host  • [white]a[-] Add  • [white]e[-] Edit  • [white]g/G[-] Ping (All)  • [white]K[-] Install Key  • [white]d[-] Delete  • [white]p[-] Pin/Unpin  • [white]i[-] Import  • [white]/[-] Search  • [white]q[-] Quit"
}
